...
.Title1 {
	...
	<body bgcolor="ffffff" background="./images/bg3.jpeg" BGCOLOR="FFFFFF"
		...
		<center>
			...
			<td width="8%">
				<font color="#CCCCCC">&nbsp; <a href="./jsps/Home.jsp"><font
						color="Thikblue"><strong><b> Home</b> </strong> </font> </a> </font>
			</td>
		...
		<form action="<%=request.getContextPath() + "/RegisterAction"%>"
			name="register" method="post" onsubmit="return validate()">
			...
			<table border='0' align="center" width=70%
					...
					<td width="276">
						<select name="logintype" onChange="cleartext()">
							...
							<option value="students">
								<font size="3" face="Verdana">students</font>
							</option>
							<option value="faculty">
								<font size="3" face="Verdana">faculty</font>
							</option>
							<option value="industry experts">
								<font size="3" face="Verdana">industry experts</font>
							</option>
				...
				<tr>
					...
					<td>
						<input type="text" name="sans" value="" size="20" />
					</td>
				<tr>
					<td>

						Select Course :
						<select style="width: 200px;" name="subname" id="select">
							<option>
								--SELECT--
							</option>
							<c:if test="${not empty subject}">
								<c:forEach var="Subname" items="${subject}">
									<option value="${Subname.subname}">
										${Subname.subname}
									</option>
								</c:forEach>
							</c:if>
					...
					<td>
						Select College:
						<select style="width: 200px;" name="collegeid" id="select">
							<option>
								--SELECT--
							</option>
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("username","req","Please enter your Username");
   ...
   frmvalidator.addValidation("logintype","req","Select UserType");
   ...
   frmvalidator.addValidation("logintype","dontselect=0");
    ...
    frmvalidator.addValidation("sans","req","Please enter your Security Answer");
  
    
    
 frmvalidator.addValidation("subname","dontselect=0");
 frmvalidator.addValidation("collegeid","dontselect=0");
